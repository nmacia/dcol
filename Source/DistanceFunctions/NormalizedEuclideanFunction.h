...
#ifndef NORMALIZEDEUCLIDEANDISTANCE_H
#define NORMALIZEDEUCLIDEANDISTANCE_H
...
\brief Implements the normalized Euclidean distance function for continuous attributes.

This is an implementation of the DistanceFunction abstract class for continuous attributes.
It implements the normalized Euclidean distance.
...
class NormalizedEuclideanFunction : public DistanceFunction {
...
public:
    ...
    /**
     * Constructs a new NormalizedEuclideanFunction object.
     * @param min is the minimum value that the attribute can take.
     * @param max is the maximum value that the attribute can take.
     */
    NormalizedEuclideanFunction ( float min, float max );

    /**
     * Destructs the NormalizedEuclideanFunction object.
     */
